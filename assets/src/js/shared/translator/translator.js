		...
		$ ( document ).ready ( function ()
		                       {
			                       ...
			                       $.getJSON (
				                       path_to_language_files + '/' + localStorage.getItem ( 'language' ) + ".json",
					                       ...
					                       $ ( '.___' ).each ( function ()
					                                           {
						                                           ...
						                                           if ( $ ( this ).data ( 'text' ) )
							                                           {
								                                           ...
								                                           var translated_text = translation[ $ ( this )
									                                           .data ( 'text' ) ];
						                                           ...
						                                           if ( $ ( this ).data ( 'title' ) )
							                                           {
								                                           var translated_title = translation[ $ (
									                                           this ).data ( 'title' ) ];
						                                           ...
						                                           if ( $ ( this ).data ( 'placeholder' ) )
							                                           {
								                                           ...
								                                           var translated_placeholder = translation[ $ (
									                                           this ).data (
									                                           'placeholder' ) ];
						                                           ...
						                                           if ( $ ( this ).data ( 'alt' ) )
							                                           {
								                                           ...
								                                           var translated_alt = translation[ $ ( this )
									                                           .data (
										                                           'alt' ) ];
