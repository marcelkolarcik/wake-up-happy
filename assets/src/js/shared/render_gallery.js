...
export function render_gallery ( room )
	{
		...
		var room_view = `<div class="carousel-item active" >
			      <img src="assets/src/images/views/${ view_types[ room.p_view ] }.jpg" class="d-block w-100" alt="room view image" >
		...
		var room_style = ` <div class="carousel-item ">
			      <img src="assets/src/images/bedrooms/b${ room.room_style }.jpg" class="d-block w-100" alt="bedroom image">
		...
		var breakfast = `<div class="carousel-item " >
			      <img src="assets/src/images/breakfast/br_${ room.food_id || 1 }.jpg" class="d-block w-100" alt="breakfast image">
			      <div class="carousel-caption d-none d-md-block">
		...
		var lunch = ` <div class="carousel-item " >
			      <img src="assets/src/images/lunch/l_${ room.food_id || 1 }.jpg" class="d-block w-100" alt="lunch image" >
			      <div class="carousel-caption d-none d-md-block">
		...
		var dinner = `<div class="carousel-item " >
			      <img src="assets/src/images/dinner/d_${ room.food_id || 1 }.jpg" class="d-block w-100" alt="dinner image" >
			      <div class="carousel-caption d-none d-md-block">
