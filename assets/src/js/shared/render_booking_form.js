		...
		booking_form.append ( `
			 <div class = "center-form" >
                        <form   id="bookings${ room.p_id }">
                            ...
                            <!--BOARDS SELECTED-->
                             <div class = "col-auto ${ sessionStorage.getItem ( 'edit_mode' )
                            ...
                            <div class = "col-auto ${ sessionStorage.getItem ( 'edit_mode' )
                                ...
                                <div class = "input-group mb-2" >
                                    ...
                                    <input type = "text" name = "name"
										...
										${ sessionStorage.getItem ( 'edit_mode' )
		                                   && !window.location.pathname.includes ( '/index.html' ) ? '' : 'required' } >
                                </div >
                            </div >
                        ...
                        <div class = "input-group mb-2" >
                            ...
                            <input type = "text" class = "form-control form-control-sm ___ green_dark
                                   ...
                                   data-placeholder = "Card Holder Name" ${ sessionStorage.getItem ( 'edit_mode' )
