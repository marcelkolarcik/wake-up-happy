...
<div class = "card  col-lg-2 col-md-3 col-sm-4 col-4 room_type_images " >
    ...
    <div class = "p-0 card-footer text-center bg-secondary text-light d-flex justify-content-around align-items-center room_type"
         id = "room_type_${room_type}" >
        <label for = "${room_types[ room_type ]}" class = "text-capitalize" >${room_types[ room_type ]}</label >
        <input id = "${room_types[ room_type ]}" name = "room_type" type = "radio" value = "${room_type}"
	...
	for ( let view_type in view_types ) {
		view_types_div.append( `
			<div class = "card col-lg-2 col-md-3  col-sm-4 col-4 text-center view_type_images d-none" >
			    ...
			    <div class = "card-footer text-center bg-secondary text-light d-flex justify-content-around align-items-center view_type p-0"
...
function render_room_styles() {
	...
	for ( let room_style in room_styles ) {
		...
		<div class = "card col-lg-2 col-md-3  col-sm-4 col-4 text-center room_style_images d-none" >
		    ...
		    <div class = "p-0 card-footer text-center bg-secondary text-light d-flex justify-content-around align-items-center room_style"
...
function render_board_types() {
    ...
    <div class = "card-footer text-center bg-secondary text-light board_type_${board_type}"
...
function render_amenities() {
	...
	for ( let amenity in amenities_list ) {
		...
		<div class = "card col-lg-4 col-md-6 col-sm-12 col-12 text-center amenities d-none" >
		    <div class = "card-footer text-center bg-secondary text-light  p-0 amenity${amenity}" id = "amenity${amenity}" >
		        <div class = "input-group mb-2" >
		            <div class = "input-group-prepend" >
		                <div class = "input-group-text bg-transparent border_bottom_only" >
		                    <input id = "${amenities_list[ amenity ]}" class = "amenity_type check" name = "amenities"
		                           type = "checkbox" value = "${amenity}"
		                           data-type = "amenity"
