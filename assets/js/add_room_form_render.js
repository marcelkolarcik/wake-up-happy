/*RENDERING FORM TO ADD ROOM, USING SET  room_types,board_types,views,amenities_list,room_styles FROM
 * LOCAL STORAGE,ON THE FORM OWNER IS PRESENTED WITH MULTIPLE OPTIONS FOR   room_types,board_types,views,amenities_list,room_style*/
...
/*IF OWNER IS ADDING THE ROOM, THERE IS NO ROOM YET*/
if ( sessionStorage.getItem ( 'add_mode' ) ) {
	room = null;
}
// OTHERWISE IF WE HAVE ROOM TO EDIT , WE WILL RETRIEVE OWNERS CHOICES FOR EACH PART OF THE FORM
// AND SET THEM AS SELECTED OPTIONS THROUGHOUT THE FORM
else if ( (
...
function render_room_types () {
	...
	$ ( '#room_types_title' ).append ( `
			...
			<p class = "card-text p-2 show_content" data-hidden_class = "room_type_images" >
			 ...
			 <!--IF WE HAVE OWNERS ROOM , GIVING GREEN LIGHT-->
